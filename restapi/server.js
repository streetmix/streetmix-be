...
server.head('/v1/streets', resources.v1.streets.find)

server.del('/v1/streets/:street_id', resources.v1.streets.delete)
server.head('/v1/streets/:street_id', resources.v1.streets.get)
...
new CronJob('23 39 * * * *', cronJobs.system_command(__dirname + "/../bin/email_heroku_db_stats.sh"), null, true)
